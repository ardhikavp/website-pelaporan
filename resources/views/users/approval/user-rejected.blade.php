...
@section('content')
    <div class="container">
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
            ...
            <a href="{{ route('users.rejected') }}" class="btn btn-primary" id="btn-users-rejected">Rejected</a>
        </div>
                ...
                <tbody>
                    @foreach ($rejectedUsers as $user)
                        <tr>
                            ...
                            <td>{{ $user->role }}</td>
                            <td>
                                <a href="#" class="btn btn-primary mr-2"><i class="bi bi-pencil-square" data-bs-toggle="tooltip" data-bs-placement="top" title="edit"></i> Edit</a>
