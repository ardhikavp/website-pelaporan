...
class NewNeedApproveSafetyObservation extends Notification
{
    use Queueable;
    ...
    {
        $url = route('safety-observation-forms.approve-by-manager', ['safety_observation_form' => $this->newApprove->id]);
        return (new MailMessage)
                ->line('Tinjauan Dokumen Safety Observation')
